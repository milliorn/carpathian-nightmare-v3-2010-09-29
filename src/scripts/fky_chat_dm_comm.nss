...
void main ()
{
            ...
            /*r*/       case 22:
                        if (sDMText == "rez")
                        {
                            ...
                            if (((!VerifyDMKey(oDMTarget)) && (!VerifyAdminKey(oDMTarget))) || (oDMTarget == oDMPC))
                            {
                                ApplyEffectToObject(2, EffectHaste(), oDMTarget);
            ...
            /*u*/       case 28:
                        ...
                        else if (sDMText == "unbanshout")
                        {
                            ...
                            else SetCampaignInt("FKY_CHT", "FKY_CHT_BANSHOUT" + sKey, FALSE);
                            //DeleteCampaignVariable("FKY_CHT", "FKY_CHT_BANSHOUT" + sKey);
