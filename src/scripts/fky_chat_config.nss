...
const int PERMANENT_CHANNEL_MUTING_FOR_PC_ONLY = FALSE;//Set this to FALSE to have permanent channel muting affect
//NPCs as well as PCs. Server shouts will be unaffacted.

const int DISABLE_TALK_CHANNEL = FALSE;
const int DISABLE_SHOUT_CHANNEL = FALSE; //Handled by a var set on the module instead
