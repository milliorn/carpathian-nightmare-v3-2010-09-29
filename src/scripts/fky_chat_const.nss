...
const string ANON = "You are now anonymous.";
const string UNANON = "You are no longer anonymous.";
...
//Most languages don't need translation, as they aren't in english to begin with. The cant-type
//languages, however, have english descriptions.
//Thieves' Cant

const string CANT_A = "*shields eyes*";
const string CANT_B = "*blusters*";
const string CANT_C = "*coughs*";
const string CANT_D = "*furrows brow*";
const string CANT_E = "*examines ground*";
const string CANT_F = "*frowns*";
const string CANT_G = "*glances up*";
const string CANT_H = "*looks thoughtful*";
const string CANT_I = "*looks bored*";
const string CANT_J = "*rubs chin*";
const string CANT_K = "*scratches ear*";
const string CANT_L = "*looks around*";
const string CANT_M = "*mmm hmm*";
const string CANT_N = "*nods*";
const string CANT_O = "*grins*";
const string CANT_P = "*smiles*";
const string CANT_Q = "*shivers*";
const string CANT_R = "*rolls eyes*";
const string CANT_S = "*scratches nose*";
const string CANT_T = "*turns a bit*";
const string CANT_U = "*glances idly*";
const string CANT_V = "*runs hand through hair*";
const string CANT_W = "*waves*";
const string CANT_X = "*stretches*";
const string CANT_Y = "*yawns*";
const string CANT_Z = "*shrugs*";

//Drow Sign Language

const string DROW_A = "*shields left thumb with right hand*";
const string DROW_B = "*makes a fist, then extends fingers rapidly*";
const string DROW_C = "*makes a fist*";
const string DROW_D = "*curls fingers towards palm*";
const string DROW_E = "*runs right index finger against the left index finger*";
const string DROW_F = "*taps thumbs together*";
const string DROW_G = "*stretches fingers wide*";
const string DROW_H = "*taps palm four times*";
const string DROW_I = "*rubs palm and forefinger together*";
const string DROW_J = "*rubs palm with thumb*";
const string DROW_K = "*holds hand up, pinky curled down*";
const string DROW_L = "*flips palm around*";
const string DROW_M = "*makes a cutting motion with two fingers*";
const string DROW_N = "*waves three fingers forward*";
const string DROW_O = "*makes an 'X' with fingers*";
const string DROW_P = "*holds fingers still*";
const string DROW_Q = "*flexes fingers*";
const string DROW_R = "*taps index finger in other hand's palm*";
const string DROW_S = "*makes a small slash with four fingers*";
const string DROW_T = "*turns palm a bit*";
const string DROW_U = "*holds palm flat, index finger down*";
const string DROW_V = "*gestures with one finger in a circle*";
const string DROW_W = "*waves two fingers forward*";
const string DROW_X = "*holds palm vertical*";
const string DROW_Y = "*holds palm horizontal*";
const string DROW_Z = "*slashes two fingers in the air*";

//Assassin's Cant

const string ASSN_A = "*sighs, sadly*";
const string ASSN_B = "*looks down*";
const string ASSN_C = "*winks*";
const string ASSN_D = "*sighs, thoughtfully*";
const string ASSN_E = "*looks up*";
const string ASSN_F = "*clears throat*";
const string ASSN_G = "*smiles pleasantly*";
const string ASSN_H = "*looks bored*";
const string ASSN_I = "*looks to the right*";
const string ASSN_J = "*smiles weakly*";
const string ASSN_K = "*nods politely*";
const string ASSN_L = "*looks ahead*";
const string ASSN_M = "*eyes twinkle merrily*";
const string ASSN_N = "*cracks a finger*";
const string ASSN_O = "*taps foot to a musicial beat*";
const string ASSN_P = "*looks sad*";
const string ASSN_Q = "*grins*";
const string ASSN_R = "*taps foot impatiently*";
const string ASSN_S = "*rolls eyes*";
const string ASSN_T = "*looks to the left*";
const string ASSN_U = "*frowns*";
const string ASSN_V = "*scratches left knuckle with right hand*";
const string ASSN_W = "*smiles*";
const string ASSN_X = "*gives a half-smile*";
const string ASSN_Y = "*scratches chin*";
const string ASSN_Z = "*stretches legs*";
...
const string COMMAND9 = "(must be targeted by tell or command targeter) = Lists the target's Playername, CD Key, IP, Classes, Experience, Experience Needed for Next Level, Area, Partymembers, Diety, Subrace, Gold, and Gold Plus Inventory Value.";
const string COMMAND10 = "(must be targeted by tell or command targeter) = Lists the target's Playername, CD Key, Classes, Experience, Experience Needed for Next Level, Area, and Partymembers. If used on yourself it also shows Diety, Subrace, Gold, and Gold Plus Inventory Value. You may hide all but your Playername and CD Key from other players by using the ";
const string COMMAND10b = "command.";
const string COMMAND10_1 = "= Hides your class, experience, area, and partymember information from other players using the ";
const string COMMAND10_2 = "= Removes your anonymous staus, allowing other players to see your class, experience, area, and partymember information.";
...
const string DMCOMMAND49 = "= All creatures in the area of the target have their faction reputation set to 100 (ally) for the enemy, merchant, commoner, and defender factions. May also be targeted at the area itself by clicking the ground.";
const string DMCOMMAND50 = "= All creatures in the area of the target have their faction reputation set to 0 (enemy) for the enemy, merchant, commoner, and defender factions. May also be targeted at the area itself by clicking the ground.";
const string DMCOMMAND51 = "= All creatures in the area of the target have their faction reputation set to 11 (nonhostile) to the enemy faction, 50 (neutral) to the merchant faction, 91 (ally) to the commoner faction, and 100 to the defender faction. May also be targeted at the area itself by clicking the ground.";
const string DMCOMMAND52 = "= All creatures in the area of the target have their faction reputation set to 0 (hostile) to the enemy faction, 50 (neutral) to the merchant faction, 91 (ally) to the commoner faction, and 100 to the defender faction. May also be targeted at the area itself by clicking the ground.";
const string DMCOMMAND53 = "= The target has their faction reputation set to 100 (ally) for the enemy, merchant, commoner, and defender factions.";
const string DMCOMMAND54 = "= The target has their faction reputation set to 0 (enemy) for the enemy, merchant, commoner, and defender factions.";
const string DMCOMMAND55 = "= The target has their faction reputation set to 11 (nonhostile) to the enemy faction, 50 (neutral) to the merchant faction, 91 (ally) to the commoner faction, and 100 to the defender faction.";
const string DMCOMMAND56 = "= The target has their faction reputation set to 0 (hostile) to the enemy faction, 50 (neutral) to the merchant faction, 91 (ally) to the commoner faction, and 100 to the defender faction.";
const string DMCOMMAND57 = "= All creatures in the area of the target except pcs have their faction reputation set to 100 (ally) for the enemy, merchant, commoner, and defender factions. May also be targeted at the area itself by clicking the ground.";
const string DMCOMMAND58 = "= All creatures in the area of the target except pcs have their faction reputation set to 0 (enemy) for the enemy, merchant, commoner, and defender factions. May also be targeted at the area itself by clicking the ground.";
const string DMCOMMAND59 = "= All creatures in the area of the target except pcs have their faction reputation set to 11 (nonhostile) to the enemy faction, 50 (neutral) to the merchant faction, 91 (ally) to the commoner faction, and 100 to the defender faction. May also be targeted at the area itself by clicking the ground.";
const string DMCOMMAND60 = "= All creatures in the area of the target except pcs have their faction reputation set to 0 (hostile) to the enemy faction, 50 (neutral) to the merchant faction, 91 (ally) to the commoner faction, and 100 to the defender faction. May also be targeted at the area itself by clicking the ground.";
const string DMCOMMAND61 = "= All players in the party of the target have their faction reputation set to 100 (ally) for the enemy, merchant, commoner, and defender factions.";
const string DMCOMMAND62 = "= All players in the party of the target have their faction reputation set to 0 (enemy) for the enemy, merchant, commoner, and defender factions.";
const string DMCOMMAND63 = "= All players in the party of the target have their faction reputation set to 11 (nonhostile) to the enemy faction, 50 (neutral) to the merchant faction, 91 (ally) to the commoner faction, and 100 to the defender faction.";
const string DMCOMMAND64 = "= All players in the party of the target have their faction reputation set to 0 (hostile) to the enemy faction, 50 (neutral) to the merchant faction, 91 (ally) to the commoner faction, and 100 to the defender faction.";
const string DMCOMMAND65 = "= All players in the party of the target receive the amount of experience specified. Command format is ";
const string DMCOMMAND66 = "= All players in the party of the target receive the number of levels specified. Command format is ";
const string DMCOMMAND67 = "= All players in the party of the target lose the amount of experience specified. Command format is ";
const string DMCOMMAND68 = "= All players in the party of the target lose the number of levels specified. Command format is ";
