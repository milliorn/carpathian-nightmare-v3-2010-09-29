...
void main(){}/*
{
    ...
    string sPlayer =  GetPCPublicCDKey(oPC);
    ...
    if (GetLocalInt(GetModule(), "STOP_BANK") == 1)
    {
        FloatingTextStringOnCreature("<cú>CANNOT USE CHEST WHEN SERVER SEQUENCE"+
        " IS ACTIVATED!  ITEMS PUT INTO CHEST WILL NOT BE SAVED!!!", oPC, FALSE);
        SendMessageToAllDMs("PLAYER: "+sPlayer+" BANKED AN ITEM DURING RESET"+
        " NAME: "+sName+".");
    }
