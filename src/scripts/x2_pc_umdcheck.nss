...
const int CRAFT_DC = 50;  //This is the spellcraft DC
const int UMD_DC = 40;    //This is the base UMD Scroll DC - assumes you are using a scroll - items will be 5 less per PHB
