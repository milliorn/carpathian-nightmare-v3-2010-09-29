...
// End of Spell Cast Hook
    ...
    effect eSkillAnimal = EffectSkillIncrease(SKILL_LISTEN, 4 + d4());
    effect eHide = EffectSkillIncrease(SKILL_HIDE, 4 + d4());
    effect eMove = EffectSkillIncrease(SKILL_MOVE_SILENTLY, 4 + d4());
    effect eSearch = EffectSkillIncrease(SKILL_SPOT, 4 + d4());
